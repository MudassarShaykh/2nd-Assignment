  ...
  return (
    <div>
      <div className="flex items-center justify-center h-screen flex-col gap-4">
        <h1 className="text-3xl text-gray-800 font-medium hover:scale-125 hover:underline transition-all duration-300">Portfolio.</h1>
      <div className="flex items-center justify-center flex-col h-fit p-4 border-2 rounded-lg border-black bg-gray-800 gap-4 hover:scale-110 transition-transform duration-300">
        ...
        <p>My name is <span className="font-semibold text-red-500">Mudassar</span></p>
